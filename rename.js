...
const DEFAULT_NAME = 'circular-draggable-progress-bar'
const DEFAULT_SHORT_NAME = 'RNCircularDraggableProgressBarModule'
const DEFAULT_URL =
	'https://github.com/abltcy/circular-draggable-progress-bar#readme'
const DEFAULT_GIT_URL =
	'https://github.com/abltcy/circular-draggable-progress-bar.git'
const DEFAULT_AUTHOR_NAME = 'Ahmet Baltaci'
const DEFAULT_AUTHOR_EMAIL = 'bilgi@ahmetbaltaci.com'
